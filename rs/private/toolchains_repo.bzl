...
# By default all these toolchains are registered by the rs_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:rs_toolchain",
    toolchain_type = "@rules_rs//rs:toolchain_type",
)
""".format(
            platform = platform,
